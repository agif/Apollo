var LR_imgurl = 'http://ktz.zoossoft.net/';
var LR_cddef='DCD76AC8AC94436FB83DD3C471488714';var LR_siteid = '24441621';
var LR_lxurl = 'http://ktz.zoossoft.net/';
var LR_isMobile = 0;
var LiveReceptionCode_isonline = 1;
var LR_lng = 'en';
var LR_bd68d=LR_cddef.replace(/1/g,'3').replace(/0/g,'2');var LR_sysurl = 'http://ktz.zoossoft.net/';
var LR_websiteid = 'KTZ24441621';
...
var LR_ssl = 0;
var LR_e6172=LR_bd68d.replace(/4/g,'8').replace(/5/g,'3');var LR_BLEB=LR_e6172.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	var _lr_helpalt_on=unescape("If you have any question%2c please click here for live help.");
	var _lr_helpsrc_on=unescape("lr%2fimages%2fonline_en3.gif");
	...
	var _lr_helpsrc_of=unescape("lr%2fimages%2foffline_en3.gif");
	...
	LR_hasInstall=0;
	var LR_ivite_img='http://ktz.zoossoft.net/js/tj_blue/p.gif';
...
var data='id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&NINN='+LR_BLEB;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="http://ktz.zoossoft.net/js/JS5.css" rel="stylesheet" type="text/css" />');
...
function lr_useraa() {if (typeof (openZoosUrl) != 'function') {setTimeout('lr_useraa()', 100);return;} if(LR_isMobile){return;}else {LR_UserInviteDiv = '<div id="swtbox" style="width:427px; height:268px; background:url(http://phongkhamdakhoahoancau.vn/img/popup-hoancau.gif); overflow:hidden; position:relative"><div id="swtchat" style="width: 126px; height: 32px; top: 210px; right: 169px; z-index: 2; position: absolute; "><a href="#" onclick="{0}return false;" style="display:block; text-indent:-999em;width: 126px; height: 32px; "></a></div><div id="swtchat" style="width: 126px; height: 32px; top: 210px; right: 18px; z-index: 2; position: absolute;"><a href="#" onclick="{0}return false;" style="display:block; text-indent:-999em;width: 126px; height: 32px; "></a></div><div id="swtColse" style="z-index: 2; width: 28px; height: 30px; top: -2px; right: -1px; position: absolute"><a href="javascript:void(0)" onclick="{1}return false;" style="display:block; text-indent:-999em;width: 28px; height: 30px; "></a></div></div>';}}lr_useraa();if(LR_isMobile){LR_above_flash=0;var lr_xCenter = 140;var lr_yCenter = 90;}}

        ...
        <section class="tranggiua m_content">
            <div class="content_chitiet">
                <div class="m_motbenh">
                    ...
                    <h1 class="cx title_chitiet">Keputihan</h1>
                    <ul class="list_doc listbenh_tc">
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/cara.php">
                                    <h4>Cara Pengobatan Keputihan</h4>
                                </a>
                                <p class="tj">
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/klinik.php">
                                    <h4>Klinik Pengobatan Keputihan</h4>
                                </a>
                                <p class="tj">
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/biaya.php">
                                    <h4>Biaya Untuk Pengobatan Keputihan</h4>
                                </a>
                                <p class="tj">
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                ...
                                <a href="single/k-kuning.php" class="btn btn-outline-brown waves-effect btn-sm">Lebih lanjut ... <i class="fa fa-mail-forward" aria-hidden="true"></i></a>
                            </div>
                            <div class="clear10"></div>
                        </li>
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                ...
                                <a href="single/k-darah.php" class="btn btn-outline-brown waves-effect btn-sm">Lebih Lanjut ... <i class="fa fa-mail-forward" aria-hidden="true"></i></a>
                            </div>
                            <div class="clear10"></div>
                        </li>
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                ...
                                <a href="single/penyebab.php" class="btn btn-outline-brown waves-effect btn-sm">Lebih Lanjut ... <i class="fa fa-mail-forward" aria-hidden="true"></i></a>
                            </div>
                            <div class="clear10"></div>
                        </li>
                    </ul>

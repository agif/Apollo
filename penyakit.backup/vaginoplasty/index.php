        ...
        <section class="tranggiua m_content">
            <div class="content_chitiet">
                <div class="m_motbenh">
                    ...
                    <h1 class="cx title_chitiet">Vaginoplasty</h1><hr color="#ee22d3">
                    <ul class="list_doc listbenh_tc">
                        <li class="clear">
                            <div class="hinh_tc">
                                <a href="single/cara.php">
                                    <img src="thumbnail/Operasi-Pengencangan-Vagina.jpg" class="vien_hinh bo5 mr10 img-thumbnail"/>
                                </a>
                            </div>
                            <div class="content_tc">
                                <a href="single/cara.php">
                                    <h4>Operasi Pengencangan Vagina</h4>
                                </a>
                                <p class="tj">
                        ...
                        <li class="clear">
                            <div class="hinh_tc">
                                <a href="single/klinik.php">
                                    <img src="thumbnail/Klinik-Terbaik-Operasi-Pengencangan-Vagina.jpg" class="vien_hinh bo5 mr10 img-thumbnail"/>
                                </a>
                            </div>
                            <div class="content_tc">
                                <a href="single/klinik.php">
                                    <h4>Klinik Terbaik Operasi Pengencangan Vagina</h4>
                                </a>
                                <p class="tj">
                                    Setelah melahirkan dan karena faktor usia beberapa dari wanita kemungkinan akan merasa bahwa otot vagina mereka melemah dan longgar. Hal seperti ini bisa menjadi sangat tidak nyaman, merasa ...
                                </p>
                        ...
                        <li class="clear">
                            <div class="hinh_tc">
                                <a href="single/biaya.php">
                                    <img src="thumbnail/Biaya-Operasi-Pengencangan-Vagina.jpg" class="vien_hinh bo5 mr10 img-thumbnail"/>
                                </a>
                            </div>
                            <div class="content_tc">
                                <a href="single/biaya.php">
                                    <h4>Biaya Operasi Pengencangan Vagina</h4>
                                </a>
                                <p class="tj">
                                    Peremajaan atau pengencangan vagina (vaginoplasty) adalah operasi yang bisa memperbaiki kelonggaran vagina yang disebabkan oleh persalinan atau penuaan, bisa untuk mengencangkan ...
                                </p>

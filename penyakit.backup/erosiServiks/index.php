                ...
                <div class="m_motbenh">
                    ...
                    <ul class="list_doc listbenh_tc">
                        <li class="clear">
                            <div class="hinh_tc">
                                <a href="single/gejala.php">
                                    <img src="thumbnail/gejala-erosi-serviks.jpg" class="vien_hinh bo5 mr10 img-thumbnail"/>
                                </a>
                            </div>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/cara.php">
                                    <h4>Cara Pengobatan Erosi Serviks</h4>
                                </a>
                                <p class="tj">
                                    Jika setiap wanita mengalami gejala erosi serviks, seperti sakit atau pendarahan, dokter akan menyarankan adanya kauterisasi. Salah satu metode untuk menghilangan ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/klinik.php">
                                    <h4>Klinik Pengobatan Erosi Serviks</h4>
                                </a>
                                <p class="tj">
                                    Klinik kesehatan di Indonesia yang menangani permasalahan penyakit kelamin seperti penyakit menular seksual (PMS), infeksi menular seksual (IMS), Andrologi dan Ginekologi. Salah satu klinik ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/biaya.php">
                                    <h4>Biaya Untuk Pengobatan Erosi Serviks</h4>
                                </a>
                                <p class="tj">

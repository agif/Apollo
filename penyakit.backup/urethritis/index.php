        ...
        <section class="tranggiua m_content">
            <div class="content_chitiet">
                <div class="m_motbenh">
                    ...
                    <h1 class="cx title_chitiet">Urethritis</h1><hr color="#ee22d3">
                    <ul class="list_doc listbenh_tc">
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                ...
                                <p class="tj">
                                    Gejala utama peradangan uretra (saluran yang menghubungkan kantung kemih ke lingkungan luar tubuh) dari urethritis adalah adanya rasa nyeri dengan buang air kecil (kencing atau disuria). Selain sakit ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/cara.php">
                                    <h4>Cara Pengobatan Urethritis</h4>
                                </a>
                                <p class="tj">
                                    Gejala utama peradangan uretra (saluran yang menghubungkan kantung kemih ke lingkungan luar tubuh) dari urethritis adalah adanya rasa nyeri dengan buang air kecil (kencing atau disuria). Selain sakit ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/klinik.php">
                                    <h4>Klinik Pengobatan Urethritis</h4>
                                </a>
                                <p class="tj">
                                    Salah satu klinik terbaik pengobatan urethritis yaitu di Klinik Utama Sentosa. Klinik yang menangani segala jenis permasalahan penyakit kulit dan kelamin seperti penyakit menular seksual (PMS), infeksi menular ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/biaya.php">
                                    <h4>Biaya Untuk Pengobatan Urethritis</h4>
                                </a>
                                <p class="tj">
                                    Gejala utama peradangan uretra (saluran yang menghubungkan kantung kemih ke lingkungan luar tubuh) dari urethritis adalah adanya rasa nyeri dengan buang air kecil (kencing atau disuria). Selain sakit ...
                                </p>

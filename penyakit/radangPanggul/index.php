            ...
            <div class="content_chitiet">
                <div class="m_motbenh">
                    <div class="breadcrumb_main">
                        ...
                        <div class="breadcrumb" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                            <a href="../../penyakit/radangPanggul/" itemprop="url">
                                <span itemprop="title">Radang Panggul</span>
                            </a>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <h1 class="cx title_chitiet">Radang Panggul</h1>
                    <ul class="list_doc listbenh_tc">
                        <li class="clear">
                            <div class="hinh_tc">
                                <a href="single/gejala.php">
                                    <img src="../../img/icon/NewWomen/endometritis.png" class="vien_hinh bo5 mr10 img-thumbnail"/>
                                </a>
                            </div>
                            <div class="content_tc">
                                <a href="single/gejala.php">
                                    <h4>Gejala Radang Panggul</h4>
                                </a>
                                <p class="tj">
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/cara.php">
                                    <h4>Cara Pengobatan Radang Panggul</h4>
                                </a>
                                <p class="tj">
                                    Setelah dilakukan pemeriksaan, dokter akan mengetahui jenis bakteri yang menjadi penyebab infeksi penyakit radang panggul (PID). Dalam beberapa hari setelah pengobatan dimulai ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/klinik.php">
                                    <h4>Klinik Pengobatan Radang Panggul</h4>
                                </a>
                                <p class="tj">
                                    Klinik Utama Sentosa menangani segala jenis penyakit yang berhubungan dengan penyakit kelamin. Salah satu tempat yang sangat sesuai ketika Anda ingin melakukan pengobatan penyakit kulit dan kelamin adalah ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/biaya.php">
                                    <h4>Biaya Untuk Pengobatan Radang Panggul</h4>
                                </a>
                                <p class="tj">
                                    Klinik Utama Sentosa menangani segala jenis penyakit yang berhubungan dengan penyakit kelamin. Salah satu tempat yang sangat sesuai ketika Anda ingin melakukan pengobatan penyakit kulit dan kelamin adalah ...

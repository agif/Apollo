    ...
    <!-- Stylesheet -->
    <link rel="icon" type="image/png" href="../assets/img/icon/logo-pink2-sentosa.png">
    <link rel="stylesheet" type="text/css" href="../assets/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="../assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="../assets/css/mdb.min.css">
    <link rel="stylesheet" type="text/css" href="../assets/css/style.css">
    <link rel="stylesheet" type="text/css" href="../assets/css/demo.min.css">
    <link rel="stylesheet" type="text/css" href="../assets/css/jquery.mmenu.all.min.css">
    <link rel="stylesheet" type="text/css" href="../assets/css/css.css">
    <link rel="stylesheet" type="text/css" href="../assets/css/JS5.css">
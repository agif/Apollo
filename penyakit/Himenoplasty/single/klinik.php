        ...
        <section class="tranggiua m_content">
            <div class="content_h">
                <div class="m_motbenh">
                    ...
                    <h4 class="h4-post h4-responsive"><i class="fa fa-th-large" aria-hidden="true"></i> Klinik Terbaik Penanganan Rekonstruksi Selaput Dara</h4>
                    <span class="post-time">
                        Tanggal Diposting : 10-01-2018 - Tampilan : 667
                    </span><br><br>
                    <div class="content_chitiet">
                        <p class="font-weight-bold">
                            Penanganan Rekonstruksi Selaput Dara Di Klinik Utama Sentosa
                        </p>
                        <p>
                        ...
                        <p class="special-type">
                            ...
                            </a><a href="#"><span style="color:#0000FF"><strong>>>> tanya dokter untuk penjelasan lebih lanjut mengenai rekonstruksi selaput dara <<<</strong></span>
                            <span style="color:#FF0000"><strong> &gt;&gt;&gt; [klik disini] <<< </strong></span></a>
    					</p>
     
                        <p class="font-weight-bold">
                            Faktor Pendukung Di Klinik Utama Sentosa
                        </p>
                    </div>
                    ...
                    <ul class="tinlq list_doc">
    					...
    					<!-- <li>
    						<a href="penyebab.php">
    							<img class="img-thumbnail img-responsive img-fluid" src="../thumbnail/penyebab-pengobatan-Himenoplasty.jpg"
    							 align="left">

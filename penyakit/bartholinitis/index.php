        ...
        <section class="tranggiua m_content">
            <div class="content_chitiet">
                <div class="m_motbenh">
                    ...
                    <h1 class="cx title_chitiet">Bartholinitis</h1><hr color="#ee22d3">
                    <ul class="list_doc listbenh_tc">
                        <li class="clear">
                            <div class="hinh_tc">
                                <a href="single/gejala.php">
                                    <img src="../../img/icon/NewWomen/bartholinitis.png" class="vien_hinh bo5 mr10 img-thumbnail"/>
                                </a>
                            </div>
                            <div class="content_tc">
                                <a href="single/gejala.php">
                                    <h4>Gejala bartholinitis</h4>
                                </a>
                                <p class="tj">
                                Sebagian besar kista bartholin tidak menyebabkan gejala apapun walaupun beberapa dapat menyebabkan rasa sakit saat berjalan, duduk dan saat berhubungan seksual (dispareunia) atau suatu nyeri pada genital yang selalu ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/cara.php">
                                    <h4>Cara Pengobatan bartholinitis</h4>
                                </a>
                                <p class="tj">
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/klinik.php">
                                    <h4>Klinik Pengobatan bartholinitis</h4>
                                </a>
                                <p class="tj">
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/biaya.php">
                                    <h4>Biaya Untuk Pengobatan bartholinitis</h4>
                                </a>
                                <p class="tj">

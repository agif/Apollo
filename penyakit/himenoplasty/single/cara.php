        ...
        <section class="tranggiua m_content">
            <div class="m_motbenh">
                <div class="breadcrumb_main">
                        ...
                        <div class="breadcrumb" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                            <a href="#" itemprop="url"><span itemprop="title">Operasi Rekontruksi</span></a>
                        </div>
                    <div class="clear"></div>
                </div>
                <h1 class="cx title_chitiet">Operasi Rekonstruksi Selaput Dara</h1>
                <span style="color:#A7A7A7;font-size:0.68em; float:right">
                    Tanggal Diposting : 10-01-2018 - Tampilan : 667
                </span><br><br>
                <div class="content_chitiet">
                    <p class="font-weight-bold"><u>Bagaimana Operasi Rekonstruksi Selaput Dara Dilakukan?</u></p>
                    <p>
                    ...
                    <p>
                        Adajuga wanita yang masih memiliki selaput dara yang utuh bahkan setelah berhubungan seksual untuk pertama kalinya. Sebaliknya ada wanita dengan selaput dara yang patah atau robek yang belum pernah melakukan hubungan seksual. Selaput dara tidak seharusnya pecah saat berhubungan seksual, karena kemungkinan tidak ada darah bahkan jika seorang wanita menjalani operasi rekonstruktif.
                    </p>
                    ...
                    <p style="text-align:center; margin-top: -20px; margin-bottom: 50px;">
                        ...
                        <a href="http://ktz.zoossoft.net/LR/Chatpre.aspx?id=KTZ24441621&amp;lng=en&amp;p=http://m.namkhoa.dakhoahoancau.vn/#"><span style="color:#0000FF"><strong>>>> konsultasi mengenai operasi rekonstruksi selaput dara </strong></span><span style="color:#FF0000"><strong> &gt;&gt;&gt; [klik disini] <<< </strong></span></a>
                    </p>

                    <p class="font-weight-bold"><u>Apa Operasi Rekonstruksi Selaput Dara Pada Wanita Sangat Penting?</u></p>
                    ...
                    <p class="font-weight-bold"><u>Operasi Rekonstruksi Selaput Dara Karena Beberapa Alasan</u></p>
                    <p>
                    ...
                    <li>
                        <a href="klinik.php">
                            <img class="vien_hinh bo5 mr10" src="http://namkhoa.dakhoahoancau.vn/upload/_thumbs/Images/benh-vien-cat-bao-quy-dau-tot-nhat-tphcm.jpg" width="10%" align="left" alt="Bệnh viện cắt bao quy đầu tốt nhất tại TP HCM">
                                Klinik Operasi Rekontruksi Selaput Dara
                        </a>
                    </li>
                    <hr>
                    <li>
                        <a href="biaya.php">
                            <img class="vien_hinh bo5 mr10" src="http://namkhoa.dakhoahoancau.vn/upload/_thumbs/Images/benh-vien-cat-bao-quy-dau-tot-nhat-tphcm.jpg" width="10%" align="left" alt="Bệnh viện cắt bao quy đầu tốt nhất tại TP HCM">
                                Biaya Operasi Rekontruksi Selaput Dara
                    </li>
                    <hr> 
                </ul>
            </div>

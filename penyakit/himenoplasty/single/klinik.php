    ...
    <div class="w650">
        <section class="tranggiua m_content">
            <div class="m_motbenh">
                ...
                <h1 class="cx title_chitiet">Klinik Terbaik Penanganan Rekonstruksi Selaput Dara</h1>
                <span style="color:#A7A7A7;font-size:0.68em; float:right">
                    Tanggal Diposting : 10-01-2018 - Tampilan : 667
                </span><br><br>
                <div class="content_chitiet">
                    <p class="font-weight-bold"><u>Penanganan Rekonstruksi Selaput Dara Di Klinik Utama Sentosa</u></p>
                    <p>
                    ...
                    <p style="text-align:center; margin-top: -20px; margin-bottom: 50px;">
                        ...
                        <a href="http://ktz.zoossoft.net/LR/Chatpre.aspx?id=KTZ24441621&amp;lng=en&amp;p=http://m.namkhoa.dakhoahoancau.vn/#"><span style="color:#0000FF"><strong>>>> tanya dokter untuk penjelasan lebih lanjut mengenai rekonstruksi selaput dara </strong></span><span style="color:#FF0000"><strong> &gt;&gt;&gt; [klik disini untuk berkonsultasi] <<< </strong></span></a>
                    </p>
 
                    <p class="font-weight-bold"><u>Faktor Pendukung Di Klinik Utama Sentosa</u></p>
                </div>
                ...
                <div class="container">
                    <div class="chitietbaiviet-lienquan container card">
                        <ul>
                            <li>
                                <b>Dokter Ahli Yang Dimiliki Klinik Utama Sentosa</b>
                                <p class="text-justify">
                                    Melakukan pengobatan di Klinik Utama Sentosa sangat tepat ketika Anda mengalami permasalahan dengan organ seksual Anda. Yang mana akan ditangani oleh para dokter ahli didalam bidangnya serta sudah banyak pasien yang telah disembuhkan. Proses pengobatan di Klinik Utama Sentosa sangat mengutamakan kepuasan dan kesembuhan pasiennya, sehingga sudah banyak pasien yang datang untuk berobat dan hasilnya sembuh dengan proses pengobatan  yang persentase kesembuhannya mencapai 98.5 %.
                                </p>
                            </li>
                            <li>
                                <b>Peralatan Medis Yang Sangat Mendukung Proses Pengobatan Di Klinik Utama Sentosa</b>
                                <p class="text-justify">
                                    Selain itu, pengobatan di Klinik Utama Sentosa didukung oleh peralatan medis yang sudah sangat canggih dan modern. Melakukan pengobatan di Klinik Utama Sentosa tidak akan kalah dengan melakukan pengobatan di klinik-klinik lain juga. Karena Klinik Utama Sentosa sangat dipercaya dalam menangani setiap permasalahan organ seksual.
                                </p>
                            </li>
                            <li>
                                <b>Kerahasiaan Atau Privasi Setiap Pasien Sangat Dijaga Oleh Klinik Utama Sentosa</b>
                                <p class="text-justify">
                                    Ketika Anda melakukan pengobatan di Klinik Utama Sentosa. Anda tidak perlu khawatir dengan data-data Anda, karena berobat di Klinik Utama Sentosa sangat memperhatikan apa yang menjadi kerahasiaan atau privasi pasien.
                                </p>
                            </li>
                            <li>
                                <b>Lokasi Yang Sangat Strategis Dan Mudah Untuk Diakses</b>
                                <p class="text-justify">
                                    Klinik Utama Sentosa terletak di Jakarta Indonesia. Sangat mudah untuk diakses ketika setiap orang ingin melakukan pengobatan ke Klinik Utama Sentosa. Lokasi Klinik Utama Sentosa yang sangat strategis.
                                </p>
                            </li>
                            <li>
                                <b>Dilengkapi Dengan Sistem Reservasi Secara Online</b>
                                <p class="text-justify">
                                    Saat Anda ingin melakukan pengobatan di Klinik Utama Sentosa dan tidak ingin mengantri lama saat Anda datang. Klinik Utama Sentosa sudah dilengkapi dengan sistem reservasi secara online ketika Anda ingin melakukan pendaftaran yang sangat memudahkan setiap pasien yang datang. Selain itu sangat bermanfaat untuk menghemat waktu, dan menjadi pasien yang diprioritaskan.
                                </p>
                            </li>
                        </ul>
                    </div>
                ...
                <ul class="tinlq list_doc">
                    ...
                    <li>
                        <a href="biaya.php">
                            <img class="vien_hinh bo5 mr10" src="http://namkhoa.dakhoahoancau.vn/upload/_thumbs/Images/benh-vien-cat-bao-quy-dau-tot-nhat-tphcm.jpg" width="10%" align="left" alt="Bệnh viện cắt bao quy đầu tốt nhất tại TP HCM">
                                Biaya Operasi Rekonstruksi Selaput Dara
                        </a>
                    </li>
                    <hr>
                </ul>

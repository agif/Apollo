            ...
            <div class="content_chitiet">
                <div class="m_motbenh">
                    <div class="breadcrumb_main">
                        ...
                        <div class="breadcrumb" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                            <a href="../../penyakit/himenoplasty/" itemprop="url">
                                <span itemprop="title">Himenoplasty</span>
                            </a>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <h1 class="cx title_chitiet">Himenoplasty</h1>
                    <ul class="list_doc listbenh_tc">
                        <!-- <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/gejala.php">
                                    <h4>Gejala Himenoplasty</h4>
                                </a>
                                <p class="tj">
                                    Himenoplasty pada wanita bisa berlangsung selama berminggu-minggu bahkan berbulan-bulan. Namun harus segera diobati, agar tidak ... 
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/cara.php">
                                    <h4>Operasi Rekonstruksi Selaput Dara</h4>
                                </a>
                                <p class="tj">
                                    Hymenoplasty adalah prosedur operasi yang menggunakan lipatan lapisan vagina untuk merekonstruksi selaput dara yang rusak atau dalam beberapa kasus lainnya. Prosedur ini biasanya ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/klinik.php">
                                    <h4>Klinik Terbaik Penanganan Rekonstruksi Selaput Dara</h4>
                                </a>
                                <p class="tj">
                                    Salah satu klinik yang menangani segala jenis penyakit yang berhubungan dengan organ seksual seperti menangani penyakit menular seksual (PMS), infeksi menular seksual (IMS), Andrologi dan ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/biaya.php">
                                    <h4>Biaya Pengobatan Rekonstruksi Selaput Dara</h4>
                                </a>
                                <p class="tj">
                                    Ada banyak alasan mengapa wanita banyak mempertimbangkan ketika ingin menjalani prosedur hymenoplasty. Beberapa alasan untuk melakukan hymenoplasty ...

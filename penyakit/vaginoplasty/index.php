            ...
            <div class="content_chitiet">
                <div class="m_motbenh">
                    <div class="breadcrumb_main">
                        ...
                        <div class="breadcrumb" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                            <a href="../../penyakit/vaginoplasty/" itemprop="url">
                                <span itemprop="title">Vaginoplasty</span>
                            </a>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <h1 class="cx title_chitiet">Vaginoplasty</h1>
                    <ul class="list_doc listbenh_tc">
                        <li class="clear">
                            <div class="hinh_tc">
                                <a href="single/cara.php">
                                    <img src="../../img/icon/NewWomen/Vaginoplasty.png" class="vien_hinh bo5 mr10 img-thumbnail"/>
                                </a>
                            </div>

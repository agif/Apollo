        ...
        <section class="tranggiua m_content">
            <div class="content_h">
                <div class="m_motbenh">
                    ...
                    <h3 class="h3-responsive ml-2">Vulvitis</h3>
                    <hr>
                    <ul class="list-unstyled">
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-center mb-3 mt-2">
                                    <a href="single/gejala.php">
                                         <h4 class="h4-responsive pinked-low-text">Gejala Vulvitis</h4>
                                        <hr class="pinked">
                                    </a>
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8  text-center mb-3 mt-2">
                                    <a href="single/cara.php">
                                         <h4 class="h4-responsive pinked-low-text">Pengobatan Vulvitis</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8  text-center mb-3 mt-2">
                                    <a href="single/klinik.php">
                                         <h4 class="h4-responsive pinked-low-text">Klinik Yang Menangani Penyakit Vulvitis</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-center mb-3 mt-2">
                                    <a href="single/biaya.php">
                                         <h4 class="h4-responsive pinked-low-text">Biaya Untuk Pengobatan Penyakit Vulvitis</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-center mb-3 mt-2">
                                    <a href="single/penyebab.php">
                                         <h4 class="h4-responsive pinked-low-text">Penyebab Vulvitis</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">

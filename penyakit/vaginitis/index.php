            ...
            <div class="content_chitiet">
                <div class="m_motbenh">
                    <div class="breadcrumb_main">
                        ...
                        <div class="breadcrumb" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                            <a href="../../penyakit/vaginitis/" itemprop="url">
                                <span itemprop="title">Vaginitis</span>
                            </a>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <h1 class="cx title_chitiet">Vaginitis</h1>
                    <ul class="list_doc listbenh_tc">
                        <li class="clear">
                            <div class="hinh_tc">
                                <a href="single/gejala.php">
                                    <img src="../../img/icon/NewWomen/Vaginitis.png" class="vien_hinh bo5 mr10 img-thumbnail"/>
                                </a>
                            </div>
                            <div class="content_tc">
                                <a href="single/gejala.php">
                                    <h4>Gejala Vaginitis</h4>
                                </a>
                                <p class="tj">
                                    Gejala Vaginitis Kemungkinan Banyak Jenisnya. Gejala vaginitis pada umumnya bisa meliputi Bakteri Vaginosis, Infeksi Ragi, Trichomoniasis ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/cara.php">
                                    <h4>Cara Pengobatan Vaginitis</h4>
                                </a>
                                <p class="tj">
                                    Pengobatan standar untuk penyakit vaginitis yang disebabkan oleh bakteri, meskipun pengobatan vaginitis lain telah terbukti memiliki keefektifan yang setara, namun akan dikaitkan dengan ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/klinik.php">
                                    <h4>Klinik Pengobatan Vaginitis</h4>
                                </a>
                                <p class="tj">
                                    Salah satu klinik yang terletak di Jakarta Indonesia yang menangani segala jenis atau bentuk permasalahan penyakit kulit dan kelamin seperti penyakit menular seksual (PMS), infeksi menular seksual (IMS) ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/biaya.php">
                                    <h4>Biaya Untuk Pengobatan Vaginitis</h4>
                                </a>
                                <p class="tj">
                                    Biaya kesehatan di Indonesia yang semakin meningkat. Biaya berobat yang dikeluarkan masyarakat Indonesia memang sedang mengalami perkembangan perekonomian yang terus meningkat. Dan hal seperti ini melebihi ...

            ...
            <div class="content_chitiet">
                <div class="m_motbenh">
                    <div class="breadcrumb_main">
                        ...
                        <div class="breadcrumb" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                            <a href="../../penyakit/polipServik/" itemprop="url">
                                <span itemprop="title">Polip Servik</span>
                            </a>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <h1 class="cx title_chitiet">Polip Servik</h1>
                    <ul class="list_doc listbenh_tc">
                        <li class="clear">
                            <div class="hinh_tc">
                                <a href="single/gejala.php">
                                    <img src="../../img/icon/NewWomen/polipServik.png" class="vien_hinh bo5 mr10 img-thumbnail"/>
                                </a>
                            </div>
                            <div class="content_tc">
                                <a href="single/gejala.php">
                                    <h4>Gejala Polip Servik</h4>
                                </a>
                                <p class="tj">
                                    Polip serviks kemungkinan tidak menimbulkan gejala yang nyata. Namun, ketika Anda mengalami keputihan dari lendir putih atau kuning atau periode yang tidak normal ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/cara.php">
                                    <h4>Cara Pengobatan Polip Servik</h4>
                                </a>
                                <p class="tj">
                                    Terkadang polip serviks akan melepaskan diri dari serviks (leher rahim) dengan sendirinya. Hal ini bisa terjadi saat seorang wanita sedang menstruasi atau saat melakukan hubungan seksual. menghilangkan polip serviks ...
                                </p>
                                <a href="single/cara.php" class="btn btn-outline-brown waves-effect btn-sm">Lebih Lanjut ... <i class="fa fa-mail-forward" aria-hidden="true"></i></a>
                            </div>
                            <div class="clear10"></div>
                        </li>
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/klinik.php">
                                    <h4>Klinik Pengobatan Polip Servik</h4>
                                </a>
                                <p class="tj">
                                    Klinik terbaik yang ada di Jakarta Indonesia dalam menangani permasalahan penyakit kelamin seperti penyakit menular seksual (PMS), infeksi menular seksual (IMS), Andrologi dan Ginekologi. Klinik Sentosa sangat mengutamakan ...
                                </p>
                                <a href="single/klinik.php" class="btn btn-outline-brown waves-effect btn-sm">Lebih Lanjut ... <i class="fa fa-mail-forward" aria-hidden="true"></i>
                                </a>
                            </div>
                            <div class="clear10"></div>
                        </li>
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/biaya.php">
                                    <h4>Biaya Untuk Pengobatan Polip Servik</h4>
                                </a>
                                <p class="tj">
                                    Setiap pasien yang kurang memahami sisi medis dengan baik, harus mengetahui potensi biaya tinggi yang akan dihadapi selama dalam proses pengobatan polip serviks. Dokter akan mempertimbangklan setiap  ...

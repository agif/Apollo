        ...
        <section class="tranggiua m_content">
            <div class="content_h">
                <div class="m_motbenh">
                    ...
                    <h3 class="h3-post h3-responsive">Infeksi Saluran Kemih</h3>
                    <hr>
                    <ul class="list-unstyled">
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8  text-center mb-3 mt-2">
                                    <a href="single/gejala.php">
                                         <h4 class="h4-responsive pinked-low-text">Gejala Infeksi Saluran Kemih Pada Wanita</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8  text-center mb-3 mt-2">
                                    <a href="single/cara.php">
                                         <h4 class="h4-responsive pinked-low-text">Pengobatan Infeksi Saluran Kemih Pada Wanita</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8  text-center mb-3 mt-2">
                                    <a href="single/klinik.php">
                                         <h4 class="h4-responsive pinked-low-text">Klinik Terbaik Pengobatan Infeksi Saluran Kemih Pada Wanita</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-center mb-3 mt-2">
                                    <a href="single/biaya.php">
                                         <h4 class="h4-responsive pinked-low-text">Biaya Pengobatan Infeksi Saluran Kemih Pada Wanita</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-center mb-3 mt-2">
                                    <a href="single/penyebab.php">
                                         <h4 class="h4-responsive pinked-low-text">Penyebab Infeksi Saluran Kemih</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-center mb-3 mt-2">
                                    <a href="single/kencing-berbusa.php">
                                         <h4 class="h4-responsive pinked-low-text">Kencing Berbusa</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                                        Jika air kencing atau urine terlihat berbusa, bisa jadi karena kandung kemih sudah penuh dan air kencingnya cukup cepat atau deras. Karena faktor ...
                                    </p>
                                    <a href="single/kencing-berbusa.php" class="btn btn-outline-brown waves-effect btn-sm ml-0">Lebih Lanjut ... <i class="fa fa-mail-forward" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </li>
                    </ul>

                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-center mb-3 mt-2">
                                    <a href="single/pengertian.php">
                                         <h4 class="h4-responsive pinked-low-text">Pengertian Salpingitis</h4>
                                        <hr class="pinked">
                                    </a>
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-center mb-3 mt-2">
                                    ...
                                    <p class="text-justify">
                                        Pada kasus yang lebih ringan, salpingitis kemungkinan tidak memiliki gejala. Dan berarti tuba fallopi bisa rusak ketika atau tanpa wanita itu sendiri menyadarinya telah ada infeksi ...
                                    </p>
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-center mb-3 mt-2">
                                    ...
                                    <p class="text-justify">
                                        Salpingitis adalah peradangan pada salah satu atau kedua tabung dan biasanya disebabkan oleh infeksi bakteri. Bisa akut dengan pembengkakan atau kronis yang kemungkinan tidak ...

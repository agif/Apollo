        ...
        <section class="tranggiua m_content">
            <div class="content_h">
                <div class="m_motbenh">
                    ...
                    <h3 class="h3-responsive ml-2">Cystitis</h3>
                    <hr>
                    <ul class="list-unstyled">
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8  text-center mb-3 mt-2">
                                    <a href="single/gejala.php">
                                         <h4 class="h4-responsive pinked-low-text">Gejala Cystitis</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                                        Cystitis biasanya disebabkan oleh infeksi bakteri, terjadi ketika jenis bakteri yang salah masuk ke kandung kemih. Hal ini bisa terjadi karena bakteri dipindahkan dari anus ke uretra ...
                                    </p>
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8  text-center mb-3 mt-2">
                                    <a href="single/cara.php">
                                         <h4 class="h4-responsive pinked-low-text">Cara Pengobatan Cystitis</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8  text-center mb-3 mt-2">
                                    <a href="single/klinik.php">
                                         <h4 class="h4-responsive pinked-low-text">Klinik Pengobatan Cystitis</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-center mb-3 mt-2">
                                    <a href="single/biaya.php">
                                         <h4 class="h4-responsive pinked-low-text">Biaya Untuk Pengobatan Cystitis</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                        ...
                        <li class="jumbotron ml-2 mr-2" style="border-bottom: 1px solid #df53cc;">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-center mb-3 mt-2">
                                    <a href="single/penyebab.php">
                                         <h4 class="h4-responsive pinked-low-text">Penyebab Cystitis</h4>
                                        <hr class="pinked">
                                    </a>
                                    <p class="text-justify">
                                        Cystitis biasanya disebabkan oleh infeksi bakteri, terjadi ketika jenis bakteri yang salah masuk ke kandung kemih. Hal ini bisa terjadi karena bakteri dipindahkan dari anus ke uretra ...

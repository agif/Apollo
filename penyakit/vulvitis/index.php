            ...
            <div class="content_chitiet">
                <div class="m_motbenh">
                    <div class="breadcrumb_main">
                        ...
                        <div class="breadcrumb" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                            <a href="../../penyakit/vulvitis/" itemprop="url">
                                <span itemprop="title">Vulvitis</span>
                            </a>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <h1 class="cx title_chitiet">Vulvitis</h1>
                    <ul class="list_doc listbenh_tc">
                        <li class="clear">
                            <div class="hinh_tc">
                                <a href="single/gejala.php">
                                    <img src="../../img/icon/NewWomen/Vulvitis.png" class="vien_hinh bo5 mr10 img-thumbnail"/>
                                </a>
                            </div>
                            <div class="content_tc">
                                <a href="single/gejala.php">
                                    <h4>Gejala Vulvitis</h4>
                                </a>
                                <p class="tj">
                                    Gejala nya bisa meliputi Adanya rasa gatal yang berlebihan secara ekstrem atau kontan, Panas atau seperti sensasi terbakar didaerah vulva (bagian organ seksual eksternal wanita yang merupakan area yang mengelilingi lubang kencing dan vagina) ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/cara.php">
                                    <h4>Cara Pengobatan Vulvitis</h4>
                                </a>
                                <p class="tj">
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/klinik.php">
                                    <h4>Klinik Pengobatan Vulvitis</h4>
                                </a>
                                <p class="tj">
                                    Salah satu klinik yang menangani permasalahan penyakit kulit dan kelamin yang berada di Jakarta. Menangani penyakit menular seksual (PMS), infeksi menular seksual (IMS), Andrologi dan Ginekologi ...
                                </p>
                        ...
                        <li class="clear">
                            ...
                            <div class="content_tc">
                                <a href="single/biaya.php">
                                    <h4>Biaya Untuk Pengobatan Vulvitis</h4>
                                </a>
                                <p class="tj">
                                    Karena sudah banyak pasien yang datang untuk berobat dan hasilnya dinyatakan sembuh oleh dokter. Sehingga Klinik Sentosa menjadi salah satu klinik yang dipercaya ...

                ...
                <div class="content_h">
                    <div class="m_motbenh">
                        ...
                        <div class="content_chitiet">
                            ...
                            <p>
                                Memahami penyebab Servicitis yang penting untuk memungkinkan pencegahan infeksi kandung kemih selanjutnya.
                            </p>
                            ...
                            <div class="chitietbaiviet-lienquan container card">
                                <ul class="red-text">
                                    <li><big>Olahraga atau diet ekstrem</big>
                                        <p class="black-text">
                                            Berolahraga terlalu banyak bisa membuang waktu pendarahan Servicitis dan terkadang berhenti. Sudah biasa bagi atlit ketahanan nya, mengurangi berat badan, olahraga ekstrem, gangguan makan, atau penyakit yang lainnya memiliki efek yang sama.
                                        </p>
                                    </li>
                                    <li><big>Tekanan</big>
                                        <p class="black-text">
                                    ...
                                    <li><big>Pil KB</big>
                                        <p class="black-text">
                                            Pil KB dapat membuat Servicitis lebih ringan atau menyebabkan terlewatnya masa Servicitis atau memiliki periode Servicitis yang kurang atau lebih atau bahkan tidak ada periode sama sekali.
                                        </p>
                                    </li>
                                    ...
                                    <li><big>Usia</big>
                                        <p class="black-text">
                                            Saat remaja mulai mengalami Servicitis, siklus Servicitis kemungkinan tidak selalu sesuai jadwal setiap bulannya. Kemungkinan membutuhkan beberapa tahun untuk menyelesaikan sebuah pola. Selain itu, periode terjawab dan periode yang lebih ringan atau lebih beat sering terjadi pada wanita menjelang menopause.
                                        </p>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <p class="special-type">
                                <a href="#" style="text-align: center;"><span class="special-rgb"><strong><img src="../../../img/icon/special-icon.gif"></strong></span></a>
                                <a href="#"><span style="color:#0000FF"><strong>>>> butuh bantuan chat online </strong></span><span style="color:#FF0000"><strong> &gt;&gt;&gt; [klik disini] <<< </strong></span></a>
                            </p>
